        ...
        <section className="min-h-screen flex items-center justify-center">
          <div className="max-w-4xl space-y-5">
            ...
            <p className="text-sm md:text-base text-white/60">
              Desktop AI Chatbot · 2024
            </p>
            <p className="text-lg md:text-xl text-white/80 leading-relaxed text-justify">
              A modern desktop chatbot application built with Electron, React, and Tailwind CSS, powered by Google Gemini AI. Features a floating window that can be toggled with global hotkeys and runs in the system tray for seamless AI assistance.
            </p>
            <div className="pt-2">
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                onClick={() => window.open('https://whispr-chatbot.vercel.app/', '_blank', 'noopener,noreferrer')}
              >
                Visit live site
              </motion.button>
            </div>
